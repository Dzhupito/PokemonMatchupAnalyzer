from PyQt5.QtWidgets import QWidget, QPushButton, QVBoxLayout, QLabel, QHBoxLayout, QLineEdit, QTableWidget, QDialog
...
def createSubdata(data, tablewidget,poke1,poke2,poke3,poke4,poke5,poke6,poke7,poke8,poke9,poke10,poke11,poke12,nteamslabel,nwinslabel):
    # printing pressed
    global lastsubdata
    global currentdata
...
def fillStatisticMatrix(data, tablewidget):
    ...
    while index < page*50 and index < len(data):
        ...
        poke1.setPixmap(pic)
        if str(data[index]["players"][0]["player1_team"][0]) == data[index]["players"][0]["player1_dynamax"]:
        ...
        poke2.setPixmap(pic)
        if str(data[index]["players"][0]["player1_team"][1]) == data[index]["players"][0]["player1_dynamax"]:
        ...
        poke3.setPixmap(pic)
        if str(data[index]["players"][0]["player1_team"][2]) == data[index]["players"][0]["player1_dynamax"]:
        ...
        poke4.setPixmap(pic)
        if str(data[index]["players"][0]["player1_team"][3]) == data[index]["players"][0]["player1_dynamax"]:
        ...
        if len(data[index]["players"][0]["player1_team"]) > 4:
            ...
            poke5.setPixmap(pic)
            if str(data[index]["players"][0]["player1_team"][4]) == data[index]["players"][0]["player1_dynamax"]:
        ...
        if len(data[index]["players"][0]["player1_team"]) > 5:
            ...
            poke6.setPixmap(pic)
            if str(data[index]["players"][0]["player1_team"][5]) == data[index]["players"][0]["player1_dynamax"]:
        ...
        poke7.setPixmap(pic)
        if str(data[index]["players"][1]["player2_team"][0]) == data[index]["players"][1]["player2_dynamax"]:
        ...
        poke8.setPixmap(pic)
        if str(data[index]["players"][1]["player2_team"][1]) == data[index]["players"][1]["player2_dynamax"]:
        ...
        poke9.setPixmap(pic)
        if str(data[index]["players"][1]["player2_team"][2]) == data[index]["players"][1]["player2_dynamax"]:
        ...
        if str(data[index]["players"][1]["player2_team"][3]) == data[index]["players"][1]["player2_dynamax"]:
        ...
        if len(data[index]["players"][1]["player2_team"]) > 4:
            ...
            if str(data[index]["players"][1]["player2_team"][4]) == data[index]["players"][1]["player2_dynamax"]:
        ...
        if len(data[index]["players"][1]["player2_team"]) > 5:
            ...
            if str(data[index]["players"][1]["player2_team"][5]) == data[index]["players"][1]["player2_dynamax"]:
        ...
        #     tablewidget.setItem(index, 1, QtGui.QTableWidgetItem())
        #     tablewidget.item(index, 1).setBackground(QtGui.QColor(100,100,150))
...
def createCheckStatiscsLayout(data):
    ...
    checkteambutton.clicked.connect(lambda: createSubdata(data, tablewidget,pokemon11text.text(),pokemon12text.text(),pokemon13text.text(),pokemon14text.text(),pokemon15text.text(),pokemon16text.text(),pokemon21text.text(),pokemon22text.text(),pokemon23text.text(),pokemon24text.text(),pokemon25text.text(),pokemon26text.text(), nteamslabel, nwinslabel)) 
